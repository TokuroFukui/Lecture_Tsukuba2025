...
- 資料の誤りやサンプルコードのバグについては <a href="mailto:tokuro.fukui@artsci.kyushu-u.ac.jp?subject=筑波大集中講義2025&body=この内容を書き換えてください" target="_blank" rel="noopener noreferrer">メールで報告</a> してもらえると嬉しいです。
...
| [2. 湯川ポテンシャル](#2-湯川ポテンシャル) | [5. 中間子論 II](#4-中間子論-i-5-中間子論-ii) | [7. セミナー](#7-セミナー) | 
| [3. テンソル力](#3-テンソル力) | [6. カイラル有効場理論と最近の話題](#6-カイラル有効場理論と最近の話題) |  | 
