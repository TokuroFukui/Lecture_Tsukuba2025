...
sidebar:
  nav: "main"
header:
  overlay_image: /assets/images/TomonagaTsukuba.jpg
  overlay_filter: 0.5
custom_js:
...
から、本講義に関するチャットボットが利用可能である。このチャットボットは、大規模言語モデルの知識に加えて、講義資料や関連文献を外部知識として利用しながら質問に回答する。核力に関する質問をぜひ投げかけてみよう！</p>
...
| 2月26日 | 2月27日 | 2月28日 | 
| --- | --- | --- |
| [第一回「核力の概観」](#第一回核力の概観) | [第四回「中間子論 I」](#第四回中間子論-i-第五回中間子論-ii) |  | 
| [第二回「湯川ポテンシャル」](#第二回湯川ポテンシャル) | [第五回「中間子論 II」](#第四回中間子論-i-第五回中間子論-ii) | [第七回 セミナー](#第七回-セミナー) | 
| [第三回「テンソル力」](#第三回テンソル力) | [第六回「カイラル有効場理論と最近の話題」](#第六回カイラル有効場理論と最近の話題) |  | 
...
- <p>
    <a href="https://colab.research.google.com/github/TokuroFukui/Lecture_Tsukuba2025/blob/main/docs/assets/notebooks/2/gemtb00a04_public.ipynb" target="_blank" rel="noopener noreferrer">
      <button style="background-color: #F9AB00; color: white; padding: 10px 15px; border: none; border-radius: 5px; cursor: pointer; transition: background-color 0.3s;"
        onmouseover="this.style.backgroundColor='#D89000';"
        onmouseout="this.style.backgroundColor='#F9AB00';">
        Google Colabで開く
...
- <p>
    <a href="https://TokuroFukui.github.io/Lecture_Tsukuba2025/assets/notebooks/4-5/gemtb01d01_public.ipynb" download>
      <button style="background-color: #1C64F2; color: white; padding: 10px 15px; border: none; border-radius: 5px; cursor: pointer; transition: background-color 0.3s;"
        onmouseover="this.style.backgroundColor='#0F4CBE';"
        onmouseout="this.style.backgroundColor='#1C64F2';">
        Notebookをダウンロード
